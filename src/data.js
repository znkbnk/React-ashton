    ...
    description: (
        <div>
          ...
          <ul>
            ...
            <li>
              R70-6439 Phosphate of Iron and Steels up to 1450 MPa Pre-process
              FD if required by drg/layout/order
            </li>
            <li>
              R70-6440 Phosphate of Iron and Steels - 1450 to 1880 MPa
          ...
          <ul>
            ...
            <li>
              BAEP 0013 Passivation of Corrosion Resistant Steels and Nickel
              Based Alloys (not 440C material)
            </li>
            <li>
            ...
            <li>
              BAEP 3515 Application and Stoving of Erosion Resistant
              Polyurethane
            </li>
            <li>
        ...
        <div>
          ...
          <ul>
            <li>
              ...
              to any APPH spec. must be obtained from the customer and recorded.
