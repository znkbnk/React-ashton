const companies = [
  {
    ...
    description: (
      <div>
        ...
        <ul>
          <li>
            ABP 1-1023 (AIPS02-01-001) Chromic Acid Anodising - PFD -If required
            by Order/Drawing/Eng. Route. Where drawing calls for ABP1-1023 then
            Tartaric Sulphuric Anodising shall be used. Where drawing mentions
            Chromic Anodise then the customer must confirm whether Chromic or
            Tartaric Sulphuric Anodising is to be used.
          </li>
        </ul>
        <ul>
          ...
          <li>ABP4-2127 Application of Polyurethane to External Surfaces</li>
          <li>ABP4-2128 Application of External Paints</li>
          <li>ABP4-2130 Application of Flexible Permeable Coatings</li>
          <li>
            ABP4-2131 Application and Stoving of High Temperature Stoving Enamel
            on Steel
          </li>
          <li>
          ...
          <li>
            <b>
              (2024 and 7075 parts which are to be painted or have chromic seal
              post treatment)
            </b>
          </li>
          <li>
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <ul>
          <li>R05-6101 Penetrant Flaw Detection</li>
          <li>
            R05-6103 Magnetic Particle Flaw Detection - Do mag flaw detection
            after cadmium, Before passivation.
          </li>
          <li>R10-0701 Passivation of Stainless Steel</li>
          <li>R10-6018 Acid Pickling of Aluminium Alloys</li>
          <li>R10-6025 Hot Solvent Cleaning</li>
          <li>R10-6026 Cold Solvent Cleaning</li>
          <li>R10-6031 Abrasive Blasting</li>
          <li>R15-6151 Stress Relieving of Steels</li>
          <li>R15-6152 De-embrittlement of Steels</li>
          <li>R15-6154 De-embrittlement of Carburised Steels</li>
          <li>R15-6156 Qualification of Chemical Treatment</li>
          <li>R40-3527 Cold Curing Primer</li>
          <li>R40-6300 General Paint Requirements</li>
          <li>R40-6304 Epoxide Primer and Epoxide Finish</li>
          <li>R40-6309 Paint, Finish, Flexible Polyurethane to MM0114</li>
          <li>R40-6310 Polyurethane/PTFE Abrasion Resisting Coating</li>
          <li>R40-6319 Molybdenum Disulphide</li>
          <li>R40-6323 Surface Coating - Temporary Protection</li>
          <li>R40-6388 Paint Qualification</li>
          <li>R40-6479 Low VOC Epoxide primer (non-chromium)</li>
          <li>R40-6978 Paint, Primer, Low VOC - Chromated to MM0126</li>
          <li>
            R40-6978 Is direct alternative to R40-3527 (Iss 3) and can be used
            at production discretion
          </li>
          <li>R60-0025 Identification Marking of Parts and Assemblies</li>
          <li>R60-6403 Identification Marking - Inks</li>
          <li>R60-6408 Identification Marking - Bag and Label</li>
          <li>
            R70-6439 Phosphate of Iron and Steels up to 1450 MPa Pre-process FD
            if required by drg/layout/order
          </li>
          <li>
            R70-6440 Phosphate of Iron and Steels - 1450 to 1880 MPa Pre-process
            FD if required by drg/layout/order
          </li>
          <li>
            R70-6983 Phosphate of Steels - Nitrided or Carbon Nitrided
            Pre-process FD if required by drg/layout/order
          </li>
          <li>
            R70-6984 Phosphate of Carburised Steels Pre-process FD if required
            by drg/layout/order
          </li>
          <li>SL 4301 Protective Treatments for Hawk Aircraft</li>
        </ul>
        <h3>BAe Systems Regional Aircraft</h3>
        <ul>
          <li>Approval No. RALOA/00204/1</li>
        </ul>
        <ul>
          <li>AIPS 02-05-001 Alocrom 1200</li>
          <li>AVP 2-024 Swab Degreasing with Solvent Cleaners</li>
          <li>AVP 3-003 Epoxy Primer to Interior and Exterior Surfaces</li>
          <li>AVP 3-006 Polyurethane</li>
          <li>AVP 3-008 Flexible Permeable Finish to Interior Surfaces</li>
          <li>
            BAEP 0002 Chromic Acid Anodising - PFD only when req. by drg/order
          </li>
          <li>BAEP 0003 Sulphuric Acid Anodising</li>
          <li>BAEP 0004 Chromate Conversion (Alocrom)</li>
          <li>BAEP 0006 Phosphating of Steel</li>
          <li>BAEP 0007 Colour Anodising (Chromic)</li>
          <li>
            BAEP 0013 Passivation of Corrosion Resistant Steels and Nickel Based
            Alloys (not 440C material)
          </li>
          <li>
            BAEP 0016 Sulphuric Acid Anodising of Titanium and Titanium Alloys
          </li>
          <li>BAEP 1516 Chromate Passivation of Cadmium and Zinc</li>
          <li>BAEP 3504 Application and Stoving of Polyurethane</li>
          <li>BAEP 3505 Application of Cold Cured Epoxide</li>
          <li>
            BAEP 3506 Application and Stoving of High Temperature Stove Enamel
            on Steel
          </li>
          <li>BAEP 3508 Application and Stoving of Acrylic</li>
          <li>BAEP 3512 Cold Curing Epoxide Primer</li>
          <li>BAEP 3513 Application and Stoving of Anti-Fretting Primer</li>
          <li>
            BAEP 3515 Application and Stoving of Erosion Resistant Polyurethane
          </li>
          <li>
            BAEP 3519 Application and Stoving of Heat Resistant Stove Enamel
          </li>
          <li>
            BAEP 3524 Application and Stoving of Polyurethane Clear Lacquer
          </li>
          <li>BAEP 3527 Application of Cold Cured Adhesion Primer</li>
          <li>BAEP 3528 Application of Flexible Permeable Coatings</li>
          <li>
            BAEP 3529 Etch Primer and Finish to Surfaces Previously Primed
          </li>
          <li>BAEP 3532 Application of Low Temperature Stove Enamel</li>
          <li>
            BAEP 3536 Application and Stoving of Abrasion Resistant Coatings
          </li>
          <li>
            BAEP 3544 Application and Stoving of Bonding Primer as an Erosion
            Resistor
          </li>
          <li>BAEP 3546 Etch Primer, Polyurethane Prime and Finish</li>
          <li>BAEP 3547 Application and Stoving of Anti-Erosion Coatings</li>
          <li>PS 2051 Dry Film Lubricant - Molycote 106</li>
          <li>PS 2068 Alocrom 1200</li>
          <li>PS 2089 Passivation of Stainless Steel (not 440C material)</li>
    ...
    description: (
      <div>
        ...
        <ul>
          ...
          <li>MIL-A-8625 Type I Chromic Anodising (was FEIS101B) Class 1</li>
          <li>MIL-A-8625 Type II Sulphuric Anodising (was FEIS101B) Class 1</li>
          <li>
    ...
    description: (
      <div>
        ...
        <ul>
          ...
          <li>PN 14.06-03 Class 1B Thin Film Anodise & Chromic Seal Only</li>
  ...
  },
  {
    ...
    description: (
      <div>
        <ul>
          <li>
            Approval No. Y370 Approval granted for processes listed below. They
            do not issue their own specs. Work is done to BS and DEF standards
            and NADCAP accreditation, etc.
          </li>
        </ul>
        <ul>
    ...
    description: (
      <div>
        ...
        <ul>
          ...
          <li>
            PS5108 Phosphate (AMS2418) (Note : must be below 1450 Mpa/210 ksi)
          </li>
  ...
  },
  {
    ...
    description: (
      <div>
        <ul>
          <li>
            This approval body does not grant approvals. Approval to do work to
            any APPH spec. must be obtained from the customer and recorded.
            Examples of relevant specs. include those listed below.
          </li>
        </ul>
        <ul>
          ...
          <li>KLA 824 Paint</li>
          <li>
            KLA 834 Magnetic Flaw Detect- NB: use ASTME1444 except 1200uw/cm2
  ...
  },
  {
    ...
    description: (
      <div>
        <ul>
          <li>
            The data card number approved by Martin-Baker, not a specification.
          </li>
        </ul>{" "}
        <ul>
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <ul>
          <li>
            EM 1580-P46 Cadmium Plating (Meggitt have confirmed that we can use
            AMS 03-19)
          </li>
        ...
        <ul>
          ...
          <li>
            PS 492 Sulphuric Acid Anodising (small scratches where base material
            show require touch up using Alocrom 1200)
          </li>
          <li>
            PS 493 Chromic Acid Anodising (small scratches where base material
            show require touch up using Alocrom 1200)
          </li>
        </ul>
      </div>
    ...
    description: (
      <div>
        ...
        <ul>
          ...
          <li>MIL-A-8625 Anodising- Chromic and Sulphuric (Type I and II)</li>
          <li>
            PCS 2101 Cadmium Plating (less than 1370 MPa as minimum tensile
            strength)
          </li>
          <li>PCS 2220 Protective Chemical Treatment of Aluminium- Local</li>
          ...
          <li>
            PS 923 Manufacturing Requirements for Messier-Dowty AV8B Aircraft
            Parts
          </li>
          <li>
        ...
        <ul>
          <li>
            Messier Services Release MS UK 36 Approval No. 5107 Approvals As Per
            Messier-Dowty But Released to MSUK36 In Place of PRIDE
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    description: (
      <div>
        <ul>
          <li>
            Approval No 266 All Services Covered by Ashton & Moore's AS9100 Rev.
            D Accreditation
          </li>
        </ul>
      </div>
    ...
    description: (
      <div>
        ...
        <ul>
          ...
          <li>
            AMS 03-9 Silver Plating- Only Copper based materials with no solder
            joints
          </li>
          ...
          <li>
            Def Stan 80-225 Paint Military vehicles and equipment IRR gloss non
            aircraft
          </li>
          <li>DTD 904 Cadmium Platting</li>
          <li>DTD 939 Silver plating (Thread gauge required as per spec)</li>
        </ul>
        <ul>
        ...
        <ul>
          ...
          <li>
            AMS 2411 Silver Plate- Only allows low alloy steels, martensitic or
            precipitated hardened corrosion resistant steels (CRES)
          </li>
    ...
    description: (
      <div>
        ...
        <ul>
          ...
          <li>ASTM E1417/E1417M Liquid Penetrant Testing Standard Practice</li>
          <li>ASTM E1444 Wet Continuous Method</li>
          <li>MIL-A-8625 Anodic Coating for Aluminium and Aluminium Alloys</li>
          <li>MIL-D-5541 Chemical Conversion coatings on Aluminium</li>
          <li>NADCAP CP- Nadcap Accreditation for Chemical Processing</li>
          <li>NADCAP NDT- Nadcap Accreditation for Non-Destructive Testing</li>
          <li>
            UKWCP.001B- MSPS 100CP.001 Sulphuric Anodising- include mandatory
            alocroming of jig marks
          </li>
          <li>
            UKWCP.001C- MSPS 100CP.001 Chromic Acid Anodising- include mandatory
            alocroming of jig marks
          </li>
          <li>
            UKWCP.002- MSPS 100CP.002 Chemical Conversion Coatings on Aluminium
            Alloys
          </li>
          <li>UKWCP.004- MSPS 100CP.004 Cadmium Plating</li>
          <li>
            UKWCP.005- MSPS 100CP.005 Passivation of Corrosion-Resistant Steels
            (not 440C material)
          </li>
          <li>
    ...
    description: (
      <div>
        ...
        <ul>
          ...
          <li>RPS 661/32 PRC-Desoto 2-part epoxy/polyurethane paint system</li>
          ...
          <li>
            ...
            wherever possible as type B requires post peen cleaning and process
            substantiation)
          </li>
          ...
          <li>
            RRP58003 Penetrant Dye Inspection- need QAS, material and Issue No.
            1A2 and 1D2
          </li>
          <li>
    ...
    description: (
      <div>
        ...
        <ul>
          ...
          <li>
            RPS 666/1 Sacrificial Coating (use Type A wherever possible as Type
            B requires post peen cleaning and process substantiation)
          </li>
      ...
      <div>
        <ul>
          <li>
            ...
            GE Aviation- UK Landing Gear- Smiths Aerospace and Dowty Hydraulics
        ...
        <ul>
          ...
          <li>PS 102-4 Sulphuric Acid Anodising & dye & nickel acetate seal</li>
      ...
      <div>
        <ul>
          <li>
            ...
            B.S.E.N. I.S.O. 9001 & AS9100 Rev. D). Society of British Aerospace
            Companies (AS9100 Rev. D) Nadcap
          </li>
        </ul>
        <ul>
          <li>
    ...
    description: (
      <>
        <p>
          ...
          Defence markets, fulfil our commitment to manufacturing 4.0 and move
          with the times, we have had a busy, yet fruitful year.
        </p>
        <p>
          Helped by a Midlands Aerospace and Nottingham University ERDF
          Aerospace UP Grant, we have improved our processing, inspection, data
          analysis, IT and communication capabilities. Indeed, we have not only
          attained Cyber Essentials Certification, but as a result of an
          invitation by a major global customer, attained JOSCAR registration.
        </p>
        <p>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <p>
          JOSCAR is a system established following an initiative led by ADS
          Group and includes a growing number of prime contractors as registered
          buyers. It is a cross-sector collaborative solution that reduces the
          time, cost, resources and duplication currently needed to provide
          information to major prime customers. Holding common supplier
          information in a central system, it allows information to be accessed
          by all participating buying organisations. It's designed to make the
          process of pre-qualification or accreditation as efficient as
          possible, enabling more effective compliance with client requirements
          for business through a single process, identifying potential business
          improvement opportunities and possibly increasing your competitive
          advantage.
        </p>
        <p>
          We see this as a hugely beneficial step in aiding our company to
    ...
    image:
      "https://www.ashton-moore.co.uk/wp-content/uploads/2022/01/joscar.png",
  },
];
...
export { sections, news, companies };
